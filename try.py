...
def reg():
    ...
    print logo
    print ''
    print '\x1b[1;32;1m Fast Cloning'
    print ''
    time.sleep(1)
    try:
    ...
    r = requests.get('https://raw.githubusercontent.com/sanizeshi/try/blob/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/message/TROVHSAICEJUN1')
        reg()
...
def reg2():
    ...
    print ' Your id: ' + id
    print ''
    raw_input(' Press enter to go to Wtsap ')
    os.system('xdg-open https://wa.me/message/TROVHSAICEJUN1')
